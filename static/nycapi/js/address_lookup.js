        ...
        html += `
          <div id="data-summary" class="bg-mackerel-200/10 p-4 rounded-lg border border-mackerel-200 mb-4">
            ...
            <div class="grid grid-cols-1 gap-2">
              ...
              <div class="flex items-center justify-between ${dataSummary.lead_paint_violations ? 'text-red-600' : 'text-grey-400'} bg-white p-2 rounded border border-grey-200">
                <div class="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                ${dataSummary.lead_paint_violations ? `
                  <button onclick="scrollToSection('section-Lead_Paint_Violations')" class="text-red-600 hover:text-red-700 text-xs font-medium font-sans3 flex items-center bg-red-100 py-1 px-2 rounded transition">
                    View Data
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
